...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Utkarsh Pawade",
    description: `Pre-Final Year CSE student at IIIT Sonepat | Full-Stack Developer`,
    image: "https://www.Utkarsh.codes/assets/logo.webp",
    type: "website",
    ...customMeta,
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.Utkarsh.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.Utkarsh.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Utkarsh" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Utkarsh" />
